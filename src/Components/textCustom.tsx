...
const _TextCus: React.FC<TextCus> = ({
    selectable = false,
    scaleFontSize = 1,
    style,
    text,
    ...
    if (children != null && children.constructor == String)
        children = translate(children, settings.language) || children;

    style.fontSize = (style.fontSize || 14) * scaleFontSize;
    return (
        <TextRN
...
const TextCus = connect(mapStateToProps, { })(_TextCus)
